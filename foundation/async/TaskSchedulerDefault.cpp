...
namespace async
{
    ...
    static  thread_local WorkerThread* workerThreadIndexTLS = nullptr;
        ...
        : TaskScheduler()
    {
        ...
        workerThreadIndexTLS = new WorkerThread(this, 0, "Main  ");
        _threads[std::this_thread::get_id()] = workerThreadIndexTLS;
